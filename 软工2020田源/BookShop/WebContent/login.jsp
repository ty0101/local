...
<body>
	...
	<div class="container-fluid" style="background-color: #D1E0F0;height:430px;margin-top:-20px;">
		<div id="container" class="row">
			<div class="col-xs-7">
				<img class="imgs" src="images/loginimg1.png" />
			</div>
			<div class="col-xs-4">
				<div class="loginbar">
