<%@page import="cn.svtcc.edu.mybookshop.shoppingcart.ShoppingCart"%>
<%@page import="cn.svtcc.edu.mybookshop.shoppingcart.ShoppingItem"%>
	...
	<div class="useropt pull-right">
		...
		<c:if test="${cart!=null && cart.itemAmount>0 && silist!=null}">
			<div class="pull-right">
				...
				<a href="${ pageContext.request.contextPath}/order.jsp" class="btn btn-danger btn-sm">去结算</a>
